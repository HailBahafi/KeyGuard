          ...
          <defs>
            {paths.map((path, index) => (
              ...
              >
                ...
                <stop stopColor={beamColors.start}></stop>
                <stop offset="32.5%" stopColor={beamColors.middle}></stop>
                <stop offset="100%" stopColor={beamColors.end} stopOpacity="0"></stop>
              </motion.linearGradient>
            ))}
            ...
            >
              <stop offset="0.0666667" stopColor={beamColors.baseStroke}></stop>
              <stop offset="0.243243" stopColor={beamColors.baseStroke}></stop>
              <stop offset="0.43594" stopColor={isDark ? "white" : "#525252"} stopOpacity="0"></stop>
            </radialGradient>
          </defs>
        </svg>
      </div>
