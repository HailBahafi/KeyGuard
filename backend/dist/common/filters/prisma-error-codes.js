...
_export(exports, {
    get PrismaErrorCodes () {
        return PrismaErrorCodes;
    },
    get prismaErrorMap () {
        return prismaErrorMap;
    }
});
 ...
 */ let PrismaErrorMapper = class PrismaErrorMapper {
    /**
   * Extract target field from Prisma error meta with enhanced logic
   */ static extractTarget(target) {
     ...
     */ static extractFieldFromMessage(message) {
     ...
     */ static extractDatabaseName(message) {
     ...
     */ static extractTableName(message) {
...
const prismaErrorMap = {
    ...
    [PrismaErrorCodes.P1002]: {
        status: _common.HttpStatus.REQUEST_TIMEOUT,
    ...
    [PrismaErrorCodes.P1003]: {
        ...
        buildErrors: (e)=>({
                database: [
                    `Database "${PrismaErrorMapper.extractDatabaseName(e.message)}" does not exist`
                ]
            })
    },
    ...
    [PrismaErrorCodes.P1011]: {
        ...
        buildErrors: ()=>({
                connection: [
                    'Error establishing secure connection to database'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P1014]: {
        ...
        buildErrors: ()=>({
                datasource: [
                    'The underlying datasource kind does not exist'
                ]
            })
    },
    [PrismaErrorCodes.P1015]: {
        status: _common.HttpStatus.NOT_IMPLEMENTED,
        message: 'Unsupported database features',
        buildErrors: ()=>({
                schema: [
                    'Prisma schema uses features not supported by database version'
                ]
            })
    },
    [PrismaErrorCodes.P1016]: {
        ...
        buildErrors: ()=>({
                query: [
                    'Raw query has incorrect number of parameters'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2001]: {
        ...
        buildErrors: ()=>({
                search: [
                    'No record found matching the search criteria'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2005]: {
        ...
        buildErrors: ()=>({
                data: [
                    'Database contains invalid value for field type'
                ]
            })
    },
    [PrismaErrorCodes.P2006]: {
        ...
        buildErrors: ()=>({
                validation: [
                    'Provided value is not valid for this field'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2008]: {
        ...
        buildErrors: ()=>({
                query: [
                    'Failed to parse the database query'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2010]: {
        ...
        buildErrors: ()=>({
                query: [
                    'Raw query could not be executed'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2017]: {
        ...
        buildErrors: ()=>({
                relation: [
                    'The records for this relation are not connected'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2020]: {
        ...
        buildErrors: ()=>({
                range: [
                    'Value is out of range for the field type'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2022]: {
        ...
        buildErrors: (e)=>{
            ...
            return {
                schema: [
                    `Column ${columnField} does not exist in database`
                ]
            };
        }
    },
    ...
    [PrismaErrorCodes.P2025]: {
        ...
        buildErrors: ()=>({
                record: [
                    'Required record could not be found for this operation'
                ]
            })
    },
    [PrismaErrorCodes.P2026]: {
        ...
        buildErrors: ()=>({
                feature: [
                    'Database provider does not support this feature'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2028]: {
        ...
        buildErrors: ()=>({
                transaction: [
                    'Error in transaction API usage'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2030]: {
        ...
        buildErrors: ()=>({
                search: [
                    'No fulltext index available for search'
                ]
            })
    },
    [PrismaErrorCodes.P2031]: {
        ...
        buildErrors: ()=>({
                mongo: [
                    'MongoDB must be run as replica set for transactions'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2033]: {
        ...
        buildErrors: ()=>({
                number: [
                    'Number too large, consider using BigInt type'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P2035]: {
        ...
        buildErrors: ()=>({
                assertion: [
                    'Database assertion was violated'
                ]
            })
    },
    [PrismaErrorCodes.P2036]: {
        ...
        buildErrors: ()=>({
                connector: [
                    'Error occurred in external connector'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P3000]: {
        ...
        buildErrors: ()=>({
                migration: [
                    'Database creation failed during migration'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P3003]: {
        ...
        buildErrors: ()=>({
                migration: [
                    'Migration format has changed, manual intervention required'
                ]
            })
    },
    [PrismaErrorCodes.P3004]: {
        status: _common.HttpStatus.PRECONDITION_FAILED,
        message: 'Database is empty',
        buildErrors: ()=>({
                database: [
                    'Database is empty and requires initialization'
                ]
            })
    },
    [PrismaErrorCodes.P3005]: {
        ...
        buildErrors: ()=>({
                schema: [
                    'Cannot reset non-empty database schema'
                ]
            })
    },
    [PrismaErrorCodes.P3006]: {
        ...
        buildErrors: ()=>({
                migration: [
                    'Migration could not be applied to database'
                ]
            })
    },
    [PrismaErrorCodes.P3007]: {
        ...
        buildErrors: ()=>({
                features: [
                    'Some preview features are not allowed in migration engine'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P3009]: {
        ...
        buildErrors: ()=>({
                migration: [
                    'Found failed migrations in target database'
                ]
            })
    },
    [PrismaErrorCodes.P3010]: {
        ...
        buildErrors: ()=>({
                migration: [
                    'Migration name exceeds maximum length'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P3012]: {
        ...
        buildErrors: ()=>({
                migration: [
                    'Migration file could not be found'
                ]
            })
    },
    [PrismaErrorCodes.P3013]: {
        ...
        buildErrors: ()=>({
                datasource: [
                    'Datasource provider arrays are deprecated'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P3015]: {
        ...
        buildErrors: ()=>({
                shadow: [
                    'Shadow database could not be found'
                ]
            })
    },
    [PrismaErrorCodes.P3016]: {
        ...
        buildErrors: ()=>({
                shadow: [
                    'Could not fall back to using shadow database'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P3018]: {
        ...
        buildErrors: ()=>({
                migration: [
                    'Migration failed to apply to database'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P3020]: {
        ...
        buildErrors: ()=>({
                shadow: [
                    'Automatic shadow database creation is disabled on Azure SQL'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P3022]: {
        ...
        buildErrors: ()=>({
                ddl: [
                    'Direct DDL execution is disabled for this database'
                ]
            })
    },
    // ========================================
    ...
    [PrismaErrorCodes.P4001]: {
        ...
        buildErrors: ()=>({
                introspection: [
                    'Cannot introspect an empty database'
                ]
            })
    },
    ...
    [PrismaErrorCodes.P6000]: {
        ...
        buildErrors: ()=>({
                accelerate: [
                    'Unable to connect to Prisma Accelerate service'
                ]
            })
    },
    [PrismaErrorCodes.P6001]: {
        ...
        buildErrors: ()=>({
                accelerate: [
                    'HTTP request timeout to Prisma Accelerate'
                ]
            })
    },
    [PrismaErrorCodes.P6002]: {
        ...
        buildErrors: ()=>({
                accelerate: [
                    'Connection pool timeout in Prisma Accelerate'
                ]
            })
    },
    [PrismaErrorCodes.P6004]: {
        ...
        buildErrors: ()=>({
                accelerate: [
                    'Error measuring response time in Prisma Accelerate'
                ]
            })
    },
    [PrismaErrorCodes.P6005]: {
        ...
        buildErrors: ()=>({
                accelerate: [
                    'Prisma Accelerate connection string is invalid'
                ]
            })
    },
    [PrismaErrorCodes.P6006]: {
        ...
        buildErrors: ()=>({
                accelerate: [
                    'Prisma Accelerate edge region not found'
                ]
            })
    },
    [PrismaErrorCodes.P6008]: {
        ...
        buildErrors: ()=>({
                accelerate: [
                    'Check your Prisma Accelerate connection string'
                ]
            })
    },
    [PrismaErrorCodes.P6009]: {
        ...
        buildErrors: ()=>({
                accelerate: [
                    'Prisma Accelerate connection limit exceeded'
                ]
            })
    },
    [PrismaErrorCodes.P6010]: {
        ...
        buildErrors: ()=>({
                accelerate: [
                    'Query timeout in Prisma Accelerate'
                ]
            })
    }
};

//# sourceMappingURL=prisma-error-codes.js.map