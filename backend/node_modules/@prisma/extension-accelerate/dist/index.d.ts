...
import { Types } from '@prisma/client/runtime/client.js';
...
declare function withAccelerate(options?: WithAccelerateOptions): (client: any) => PrismaDefault.PrismaClientExtends<_prisma_client_runtime_client.InternalArgs<{}, {
    $allModels: {
        aggregate<This, FormalArgs extends _prisma_client_runtime_client.Args<This, "aggregate"> & PrismaCacheStrategy, const ActualArgs extends FormalArgs>(this: This, args: { [key in keyof ActualArgs]: key extends keyof FormalArgs ? ActualArgs[key] : never; }): AcceleratePromise<_prisma_client_runtime_client.Result<This, ActualArgs, "aggregate">>;
        count<This, FormalArgs extends _prisma_client_runtime_client.Args<This, "count"> & PrismaCacheStrategy, const ActualArgs extends FormalArgs>(this: This, args?: { [key in keyof ActualArgs]: key extends keyof FormalArgs ? ActualArgs[key] : never; }): AcceleratePromise<_prisma_client_runtime_client.Result<This, ActualArgs, "count">>;
        findFirst<This, FormalArgs extends _prisma_client_runtime_client.Args<This, "findFirst"> & PrismaCacheStrategy, const ActualArgs extends FormalArgs>(this: This, args?: { [key in keyof ActualArgs]: key extends keyof FormalArgs ? ActualArgs[key] : never; } & (ActualArgs extends {
            select: unknown;
            include: unknown;
        } ? "Please either choose `select` or `include`." : ActualArgs extends {
            select: unknown;
            omit: unknown;
        } ? "Please either choose `select` or `omit`." : unknown)): AcceleratePromise<_prisma_client_runtime_client.Result<This, ActualArgs, "findFirst"> | null>;
        findFirstOrThrow<This, FormalArgs extends _prisma_client_runtime_client.Args<This, "findFirstOrThrow"> & PrismaCacheStrategy, const ActualArgs extends FormalArgs>(this: This, args?: { [key in keyof ActualArgs]: key extends keyof FormalArgs ? ActualArgs[key] : never; } & (ActualArgs extends {
            select: unknown;
            include: unknown;
        } ? "Please either choose `select` or `include`." : ActualArgs extends {
            select: unknown;
            omit: unknown;
        } ? "Please either choose `select` or `omit`." : unknown)): AcceleratePromise<_prisma_client_runtime_client.Result<This, ActualArgs, "findFirstOrThrow">>;
        findMany<This, FormalArgs extends _prisma_client_runtime_client.Args<This, "findMany"> & PrismaCacheStrategy, const ActualArgs extends FormalArgs>(this: This, args?: { [key in keyof ActualArgs]: key extends keyof FormalArgs ? ActualArgs[key] : never; } & (ActualArgs extends {
            select: unknown;
            include: unknown;
        } ? "Please either choose `select` or `include`." : ActualArgs extends {
            select: unknown;
            omit: unknown;
        } ? "Please either choose `select` or `omit`." : unknown)): AcceleratePromise<_prisma_client_runtime_client.Result<This, ActualArgs, "findMany">>;
        findUnique<This, FormalArgs extends _prisma_client_runtime_client.Args<This, "findUnique"> & PrismaCacheStrategy, const ActualArgs extends FormalArgs>(this: This, args: { [key in keyof ActualArgs]: key extends keyof FormalArgs ? ActualArgs[key] : never; } & (ActualArgs extends {
            select: unknown;
            include: unknown;
        } ? "Please either choose `select` or `include`." : ActualArgs extends {
            select: unknown;
            omit: unknown;
        } ? "Please either choose `select` or `omit`." : unknown)): AcceleratePromise<_prisma_client_runtime_client.Result<This, ActualArgs, "findUnique"> | null>;
        findUniqueOrThrow<This, FormalArgs extends _prisma_client_runtime_client.Args<This, "findUniqueOrThrow"> & PrismaCacheStrategy, const ActualArgs extends FormalArgs>(this: This, args: { [key in keyof ActualArgs]: key extends keyof FormalArgs ? ActualArgs[key] : never; } & (ActualArgs extends {
            select: unknown;
            include: unknown;
        } ? "Please either choose `select` or `include`." : ActualArgs extends {
            select: unknown;
            omit: unknown;
        } ? "Please either choose `select` or `omit`." : unknown)): AcceleratePromise<_prisma_client_runtime_client.Result<This, ActualArgs, "findUniqueOrThrow">>;
        groupBy<This, FormalArgs extends _prisma_client_runtime_client.Args<This, "groupBy"> & PrismaCacheStrategy, const ActualArgs extends FormalArgs>(this: This, args: { [key in keyof ActualArgs]: key extends keyof FormalArgs ? ActualArgs[key] : never; }): AcceleratePromise<_prisma_client_runtime_client.Result<This, ActualArgs, "groupBy">>;
    };
}, {}, {
    $accelerate: {
        invalidate: (input: AccelerateInvalidateInput) => Promise<{
...
}> & _prisma_client_runtime_client.InternalArgs<{}, {}, {}, {}> & _prisma_client_runtime_client.DefaultArgs>;
